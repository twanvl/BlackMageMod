...
public class DarkArmor extends AbstractCustomCardWithType {
	...
	private static final String DESCRIPTION = "Gain Dark Armor for !M! turns.";
	...
	public void use(AbstractPlayer p, AbstractMonster arg1) {
		AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p, new DarkArmorPower(p, 3), 3));
	}
